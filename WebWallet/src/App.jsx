...
function WalletGenerator() {
  ...
  return (
    <div className="w-screen h-screen flex items-center justify-center p-4" style={{ backgroundColor: '#0f172a', color: '#FFFFFF' }}>
      <div className="w-full max-w-4xl" style={{ backgroundColor: '#1E293B', border: '1px solid #333', borderRadius: '12px', padding: '24px' }}>
        {/* Header */}
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-4">
            <h1 className="text-4xl font-bold" style={{ background: 'linear-gradient(45deg, #0EA5E9, #7DD3FC)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
              HD WALLET GENERATOR
            </h1>
          </div>
        </div>
                    ...
                    <div className="grid gap-4">
                      ...
                      <div>
                        ...
                        {copiedItem === `private-${account.index}` && (
                          <span className="text-xs" style={{ color: '#10B981' }}>Copied!</span>
                        )}
                        {revealedKeys.has(account.index) && (
